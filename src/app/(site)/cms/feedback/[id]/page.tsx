                ...
                ticket.comments.map((comment) => (
                  <div
                    ...
                    className={`rounded-lg border p-3 space-y-1 ${
                      comment.internal ? "border-dashed bg-muted/30" : ""
                    }`}
                  >
          ...
          {ai ? (
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-1">
                  <h4 className="text-xs font-medium text-muted-foreground">Root Cause Hypothesis</h4>
                ...
                {ai.affectedModules.length > 0 && (
                  <div className="space-y-1">
                    <h4 className="text-xs font-medium text-muted-foreground">Affected Modules</h4>
